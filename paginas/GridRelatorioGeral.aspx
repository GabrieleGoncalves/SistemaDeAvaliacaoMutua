<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/MasterPageAvaliador.master" AutoEventWireup="true" CodeFile="GridRelatorioGeral.aspx.cs" Inherits="paginas_GridRelatorioGeral" %>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="table-responsive no-padding">
                        <asp:GridView ID="gdvRelatorioGeral" runat="server" CssClass="table table-hover" AutoGenerateColumns="False" >
                            <Columns>
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="ava_codigo" DataNavigateUrlFormatString="~/paginas/RelatorioGeral.aspx?avaliacao={0}" Text="Visualizar" HeaderText="Selecionar" />
                            </Columns>
                        </asp:GridView>
                        &nbsp;
                    </div>
