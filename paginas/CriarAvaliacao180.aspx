<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/MasterPageAvaliador.master" AutoEventWireup="true" CodeFile="CriarAvaliacao180.aspx.cs" Inherits="paginas_CriarAvaliacao180" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h2 class="page-header">Criar Avaliação 180°</h2>
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Avaliação 180°</h3>
        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="checkbox">
                        <label>
                            <asp:CheckBox ID="ckbAnonimo" runat="server" CssClass="checkbox" />Definir avaliação como anônima.
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-4">
                            ...
                            <asp:ListBox ID="ltbSelecionar" runat="server" CssClass="form-control" OnSelectedIndexChanged="ltbSelecionar_SelectedIndexChanged" AutoPostBack="True"></asp:ListBox>
                        </div>
                        <div class="col-xs-4">
                            <!-- conteúdo -->
                            <label>Selecionados</label>
                            <asp:ListBox ID="ltbSelecionados" runat="server" CssClass="form-control" OnSelectedIndexChanged="ltbSelecionados_SelectedIndexChanged" AutoPostBack="True"></asp:ListBox>
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-4">
                            <!-- conteúdo -->
                            <label>Selecionar</label>
                            <asp:ListBox ID="ltbSelecionarEquipe" runat="server" CssClass="form-control" OnSelectedIndexChanged="ltbSelecionarEquipe_SelectedIndexChanged" AutoPostBack="true"></asp:ListBox>
                        </div>
                        <div class="col-xs-4">
                            <!-- conteúdo -->
                            <label>Selecionados</label>
                            <asp:ListBox ID="ltbSelecionadosEquipe" runat="server" CssClass="form-control" OnSelectedIndexChanged="ltbSelecionadosEquipe_SelectedIndexChanged" AutoPostBack="true"></asp:ListBox>
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
