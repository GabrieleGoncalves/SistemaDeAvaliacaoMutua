<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/MasterPageAdministradorComum.master" AutoEventWireup="true" CodeFile="AdministradorComum.aspx.cs" Inherits="paginas_AdministradorComum" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Administrador Comum</h3>
                </div>
                <div class="box-body">
                    <p style="text-align: justify;">
                       Cabe ao Administrador Comum realizar cadastrar importar e editar Participantes e Avaliadores, vizualizar logs e visualizar.  
                    </p>
                </div>
            </div>
        </div>
