<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/MasterPageAvaliador.master" AutoEventWireup="true" CodeFile="GridRelatorioIndividual.aspx.cs" Inherits="paginas_GridRelatorioIndividual" %>
                    ...
                    <div class="table-responsive no-padding">
                        <asp:GridView ID="gdvRelatorioIndividual" runat="server" CssClass="table table-hover" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="ava_codigo" DataNavigateUrlFormatString="~/paginas/RelatorioIndividual.aspx?avaliacao={0}" Text="Visualizar" HeaderText="Selecionar" />
                            </Columns>
                        </asp:GridView>
                        &nbsp;
                    </div>
