<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/MasterPageAvaliador.master" AutoEventWireup="true" CodeFile="AvaliacaoModelo.aspx.cs" Inherits="paginas_AvailiacaoModelo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="../plugins/daterangepicker/daterangepicker-bs3.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h2 class="page-header">Avaliação Modelo</h2>
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Avaliação Modelo</h3>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <asp:DropDownList ID="ddlTipoAvaliacao" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlTipoAvaliacao_SelectedIndexChanged1">
            ...
            <div class="row">
                <div class="col-xs-3">
                    ...
                    <asp:RequiredFieldValidator ID="rfvInicio" runat="server"  SetFocusOnError="true" ControlToValidate="txtInicio" ErrorMessage="* Insira uma data de início" EnableViewState="true" ValidationGroup="CriarAvaliacao" ForeColor="Red"></asp:RequiredFieldValidator>
                    <!-- /.input group -->
                </div>
                <div class="col-xs-3">
                    <label>Término</label>
                    ...
                    <asp:RequiredFieldValidator ID="rfvTermino" runat="server" SetFocusOnError="true" ControlToValidate="txtTermino" ErrorMessage="Insira uma data de término" EnableViewState="true" ValidationGroup="CriarAvaliacao"></asp:RequiredFieldValidator>
                    <!-- /.input group -->
            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="checkbox">
                        <label>
                            <asp:CheckBox ID="ckbAnonimo" runat="server" CssClass="checkbox" Text="Definir avaliação como anônima." Visible="false" />
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-4">
                            ...
                            <asp:ListBox ID="ltbSelecionar" runat="server" CssClass="form-control" OnSelectedIndexChanged="ltbSelecionar_SelectedIndexChanged" AutoPostBack="True" SelectionMode="Multiple"></asp:ListBox>
                        </div>
                        <div class="col-xs-4">
                            <!-- conteúdo -->
    ...
    <div class="box">
        <div class="box-header with-border">
            <div class="row">
                <div class="col-xs-12">
                    <asp:LinkButton ID="lkbCriarAvaliacao" runat="server" CssClass="btn btn-success btn-block btn-flat" Text="<i class='fa fa-book'></i> Criar Avaliação" OnClick="lkbCriarAvaliacao_Click" ValidationGroup="CriarAvaliacao"></asp:LinkButton>
