<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/MasterPageAvaliador.master" AutoEventWireup="true" CodeFile="Avaliador.aspx.cs" Inherits="paginas_Avaliador" %>
     ...
     <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Avaliador</h3>
                        </div>
                        <div class="box-body">
                            <p style="text-align: justify;">
                                O Avaliador do Sistema de Avaliação Mútua conta com as Avaliações de Desempenho de 90°, 180° e 360°, ele deve escolher os Participantes, criar os critérios e realizar a Avaliação, dando um retorno através de um relatório. 
                            </p>
                        </div>
                    </div>
                </div>
