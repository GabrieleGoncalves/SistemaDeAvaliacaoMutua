<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/MasterPageParticipante.master" AutoEventWireup="true" CodeFile="Participante.aspx.cs" Inherits="paginas_Participante" %>
...
<h2 class="page-header">Início</h2>
     <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <ol class="carousel-indicators">
                        ...
                        <a href="RedefinirSenha.aspx">RedefinirSenha.aspx</a>
                    </ol>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <p style="text-align: justify;">
                               O participante atua nas avaliações de 180° e 360° e em todas as avalições recebe um retorno de suas Avaliações realizadas.
                            </p>
                        </div>
                    </div>
                </div>
