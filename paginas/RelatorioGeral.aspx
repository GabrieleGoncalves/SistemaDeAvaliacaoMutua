<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/MasterPageAvaliador.master" AutoEventWireup="true" CodeFile="RelatorioGeral.aspx.cs" Inherits="paginas_RelatorioGeral" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Relatório Geral da avaliação</h3>
            ...
            <div class="row">
                <div class="col-xs-3">
                    <div class="form-group">
                        <label>Selecione um Participante</label>
                        <asp:DropDownList ID="ddlSelecioneEquipe" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddlSelecioneEquipe_SelectedIndexChanged">
                        </asp:DropDownList>
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <br />
                    <asp:GridView ID="gdvRelatorioIndividual" runat="server" AutoGenerateColumns="false" CssClass="table table-hover"  OnRowDataBound="gdvRelatorioIndividual_RowDataBound">
                        <Columns>
                    ...
                    <asp:Label ID="lblanonimo" runat="server" Visible="false" Text="0"></asp:Label>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12">
