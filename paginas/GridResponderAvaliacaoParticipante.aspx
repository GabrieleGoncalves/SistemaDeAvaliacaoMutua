<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/MasterPageParticipante.master" AutoEventWireup="true" CodeFile="GridResponderAvaliacaoParticipante.aspx.cs" Inherits="paginas_GridResponderAvaliacaoParticipante" %>
                    ...
                    <div class="table-responsive no-padding">
                        <asp:GridView ID="gdvResponderAvaliacao" runat="server" CssClass="table table-hover" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="ava_codigo" DataNavigateUrlFormatString="~/paginas/ResponderAvaliacaoParticipante.aspx?avaliacao={0}" Text="Responder" HeaderText="Responder" />
                            </Columns>
                        </asp:GridView>
                        &nbsp;
                    </div>
