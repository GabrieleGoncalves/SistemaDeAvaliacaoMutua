...
public partial class paginas_AvailiacaoModelo : System.Web.UI.Page
{
    int teste = 0;
    ...
    protected void btnFecharModalCriterio_Click(object sender, EventArgs e)
    {

        txtNovoCriterio.Text = String.Empty;
    ...
    protected void ddlTipoAvaliacao_SelectedIndexChanged1(object sender, EventArgs e)
    {
        if (ddlTipoAvaliacao.SelectedIndex == 0)
        {
            ckbAnonimo.Visible = false;
        }
        else
        {

            ckbAnonimo.Visible = true;
