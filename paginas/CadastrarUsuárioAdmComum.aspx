<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/MasterPageAdministradorComum.master" AutoEventWireup="true" CodeFile="CadastrarUsuárioAdmComum.aspx.cs" Inherits="paginas_CadastrarUsuárioAdmComum" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2 class="page-header">Cadastrar Usuario</h2>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <table>
                            ...
                            <tr>
                                <td>
                                     <label>Selecione o Perfil: <font color="red">*</font></label>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtDataDeNascimento" CssClass="form-control-txt" TextMode="Date" runat="server"></asp:TextBox>
                                     <asp:RequiredFieldValidator class="warning" CssClass="" ID="rfvData" runat="server" ControlToValidate="txtRG" ErrorMessage="Insira o RG">*Insira a data de nascimento</asp:RequiredFieldValidator>
                                </td>
                            </tr>
