<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/MasterPageAvaliador.master" AutoEventWireup="true" CodeFile="CriarAvaliacao360.aspx.cs" Inherits="paginas_CriarAvaliacao360" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2 class="page-header">Criar Avaliação 360°</h2>
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Avaliação 360°</h3>
        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="checkbox">
                        <label>
                            <asp:CheckBox ID="ckbAnonimo" runat="server" CssClass="checkbox"  Text="Definir avaliação como anônima." />
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-4">
                            ...
                            <asp:ListBox ID="ltbSelecionar" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ltbSelecionar_SelectedIndexChanged"></asp:ListBox>
                        </div>
                        <div class="col-xs-4">
                            <!-- conteúdo -->
                            <label>Selecionados</label>
                            <asp:ListBox ID="ltbSelecionados" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ltbSelecionados_SelectedIndexChanged"></asp:ListBox>
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <asp:Button ID="btnFecharModalCriterio" runat="server" CssClass=" btn btn-default" data-dismiss="modal" Text="Fechar" />
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-4">
                            <!-- conteúdo -->
                            <label>Selecionar</label>
                            <asp:ListBox ID="ltbSelecionarEquipe" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ltbSelecionarEquipe_SelectedIndexChanged"></asp:ListBox>
                        </div>
                        <div class="col-xs-4">
                            <!-- conteúdo -->
                            <label>Selecionados</label>
                            <asp:ListBox ID="ltbSelecionadosEquipe" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ltbSelecionadosEquipe_SelectedIndexChanged"></asp:ListBox>
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
                                            ...
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    ...
                                                    <asp:DropDownList ID="ddlPesquisarPor" runat="server" CssClass="form-control">
                                                        ...
                                                        <asp:ListItem>Matrícula</asp:ListItem>
